    ...
    <nav className="navbar w-full">
      <div className="max-width flex justify-between items-center py-4">
        ...
        <div className="flex space-x-4">
          ...
          <button className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#1F363D,45%,#000,55%,#1F363D)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors hover:outline-none focus:ring-2 hover:ring-slate-400 hover:ring-offset-2 hover:ring-offset-slate-50">Register</button>
        </div>
      </div>
